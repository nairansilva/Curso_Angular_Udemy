...
export class SubjectsComponent implements OnInit {
  ...
  subjectMaster = new Subject<DataModel>();
  ...
  ngOnInit() {
    ...
    this.subjectMaster.subscribe(this.subject);
    this.subjectMaster.subscribe(this.replaySubject);
    this.subjectMaster.subscribe(this.asyncSubject);
    this.subjectMaster.subscribe(this.behaviorSubject);

  }

  connect() {
    this.dataService.dataObservable.subscribe(this.subjectMaster);
  }
